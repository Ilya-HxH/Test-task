      ...
      <div className="max-w-screen-2xl mx-auto px-8 grid grid-cols-1 gap-8">
         ...
         <div className="grid grid-cols-2 gap-8 bg-gray-100 p-8 rounded-lg shadow-lg">
          ...
          <div className="flex flex-col justify-center">
            ...
            Lorem ipsum dolor sit amet consectetur. Mauris ullamcorper id tellus massa molestie sed. Morbi sit consectetur mauris neque. Arcu id ut in amet fusce erat. Dui nibh purus etiam ipsum. Aliquet nunc egestas at arcu adipiscing leo duis euismod pellentesque. Quam odio non sit fames tincidunt tortor aliquam elit.
              <br />
              <br />
              Lorem ipsum dolor sit amet consectetur. Mauris ullamcorper id tellus massa molestie sed. Morbi sit consectetur mauris neque. Arcu id ut in amet fusce erat. Dui nibh purus etiam ipsum. Aliquet nunc egestas at arcu adipiscing leo duis euismod pellentesque. Quam odio non sit fames tincidunt tortor aliquam elit.
              <br />
